 ...
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | LCTRL  | LGUI   | LALT   | FN     | SPACE  | SPACE  |        |        |        | SPACE  | SPACE  | FN     | RALT   | RGUI   | RCTRL  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
  ...
  { FN1_ESC, KC_A,    KC_S,    KC_D,    KC_F,   KC_G,   _______, _______, _______, KC_H,   KC_J,   KC_K,    KC_L,    KC_SCLN, FN1_QUOT  },
  { KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,   _______, _______, _______, KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC },
  { KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX, KC_ENT, KC_ENT, _______, _______, _______, KC_SPC, MO(_FN2),KC_LEFT, KC_DOWN, KC_UP, KC_RGHT },
 },
 ...
 */
 ...
 [_FN1] = { /* FUNCTION */
  ...
  { XXXXXXX, KC_1,    KC_2,    KC_3,    KC_4,   KC_5,   _______, _______, _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL  },
