...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
	...
	//--------+--------+--------+--------+-----------------+-----------------+--------+--------+--------+--------+
		KC_LCTL, KC_LALT, xxxxxxx, KC_LGUI, E___N__T__E___R,  S___P__A__C___E,  FN2,     KC_RALT, KC_RCTRL),
  ...
  //--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
	...
	//--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
		_______, _______, _______, M(1),    M(2),    _______, _______, _______, _______, _______, _______, _______,
	//--------+--------+--------+--------+-----------------+-----------------+--------+--------+--------+--------+
		_______, _______, _______, _______,  E___N__T__E___R,  S___P__A__C___E,  _______, _______, _______),
	...
	//--------+--------+--------+--------+-----------------+-----------------+--------+--------+--------+--------+
		RESET,  _______, _______, _______,  E___N__T__E___R,  S___P__A__C___E,  _______, _______, _______),
};
